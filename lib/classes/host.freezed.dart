...
/// @nodoc
mixin _$Host implements DiagnosticableTreeMixin {

 String get displayName; String get email; LatLng get homeLocation; String get photoURL; String get hid;
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('displayName', displayName))..add(DiagnosticsProperty('email', email))..add(DiagnosticsProperty('homeLocation', homeLocation))..add(DiagnosticsProperty('photoURL', photoURL))..add(DiagnosticsProperty('hid', hid));
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,displayName,email,homeLocation,photoURL,hid);

@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'Host(displayName: $displayName, email: $email, homeLocation: $homeLocation, photoURL: $photoURL, hid: $hid)';
}
...
@useResult
$Res call({
 String displayName, String email, LatLng homeLocation, String photoURL, String hid
});
...
/// Create a copy of Host
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? displayName = null,Object? email = null,Object? homeLocation = null,Object? photoURL = null,Object? hid = null,}) {
...
class _Host with DiagnosticableTreeMixin implements Host {
  const _Host({required this.displayName, required this.email, required this.homeLocation, required this.photoURL, required this.hid});
...
/// Create a copy of Host
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? displayName = null,Object? email = null,Object? homeLocation = null,Object? photoURL = null,Object? hid = null,}) {
  return _then(_Host(
displayName: null == displayName ? _self.displayName : displayName // ignore: cast_nullable_to_non_nullable
as String,email: null == email ? _self.email : email // ignore: cast_nullable_to_non_nullable
as String,homeLocation: null == homeLocation ? _self.homeLocation : homeLocation // ignore: cast_nullable_to_non_nullable
